        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-900 px-4 py-8">
            <div className="max-w-sm w-full">
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold gradient-text">Welcome Back</h2>
                    <p className="text-gray-500 text-sm mt-2">Sign in to your Data AI account</p>
                </div>
                ...
                <p className="text-center text-gray-500 text-sm mt-6">
                    Don't have an account? <Link to="/register" className="text-blue-400 hover:text-blue-300 font-medium transition-smooth">Sign up</Link>
                </p>
            </div>
        </div>
    );
